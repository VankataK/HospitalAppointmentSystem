    ...
    public partial class AddEntities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "Patient Identifier")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "Specialization Identifier"),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false, comment: "Specialization Name")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "Vacation Identifier"),
                    DoctorId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "Doctor Identifier"),
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Vacation Start Date"),
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Vacation End Date")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "Rating Identifier"),
                    AppointmentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "Appointment Identifier"),
                    Professionalism = table.Column<decimal>(type: "decimal(4,2)", nullable: false, comment: "Doctor Professionalism"),
                    Attitude = table.Column<decimal>(type: "decimal(4,2)", nullable: false, comment: "Doctor Attitude")
                },
                constraints: table =>
                {
