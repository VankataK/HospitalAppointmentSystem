    ...
    public partial class SeedDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0474b09e-b40c-4a07-821b-608382e23074"), 0, 42, "6c2c4c90-a80e-4287-969b-b140de36b022", "doctor3@mail.com", false, "Станимир", "Мъж", "Колев", false, null, "DOCTOR3@MAIL.COM", "DOCTOR3@MAIL.COM", "AQAAAAEAACcQAAAAEP/5zxJPPx/zPP7+zbwsxz6rj9mJI/QvGV3KC+EXje9eJeT2rVM+vYzWCC9AuqqAAA==", null, false, "9d2cd0f8-d36a-4709-9298-10e09991a32e", false, "doctor3@mail.com" },
                    { new Guid("14108175-e9b7-41e4-a85b-e69b16df9b60"), 0, 41, "9c5b6bca-521e-44a8-b0af-57f8c50370ce", "doctor2@mail.com", false, "Виктория", "Жена", "Стоянова", false, null, "DOCTOR2@MAIL.COM", "DOCTOR2@MAIL.COM", "AQAAAAEAACcQAAAAEGQSxCiXHDVjC1dp3E4jm182JsCrpFZhcQ+etIir3TS0BRf9fEJ6SwRQcJ3D438wJA==", null, false, "38134987-3d84-4df7-ae9c-ed988122ba31", false, "doctor2@mail.com" },
                    { new Guid("248cf7a1-4b05-461f-a6a2-155f897921de"), 0, 44, "428e63e8-1dbf-4fea-95e6-74ec9639db9a", "doctor5@mail.com", false, "Виктор", "Мъж", "Борисов", false, null, "DOCTOR5@MAIL.COM", "DOCTOR5@MAIL.COM", "AQAAAAEAACcQAAAAEAE6lhlO13nZeaETIYKFa4VHqbGBxJwJ8MYdch1zY2TiiscZOG5l8v2C3JqZe1GPoA==", null, false, "40b538a7-f23c-4a80-a725-0edec5b954a9", false, "doctor5@mail.com" },
                    { new Guid("27f342da-167d-43a6-a140-a63826b18da2"), 0, 26, "643ceecc-7471-4d2d-87f3-a4c4176bbb31", "patient2@mail.com", false, "Елена", "Жена", "Симеонова", false, null, "PATIENT2@MAIL.COM", "PATIENT2@MAIL.COM", "AQAAAAEAACcQAAAAEOlKJZyUZjGH6K6uF6415IkLwb4d2YkXvAl1FksXCQ0PqF4kQAFkz7fIgYBJDCpdRw==", null, false, "bccc80b9-53b4-4745-ab34-37723726d108", false, "patient2@mail.com" },
                    { new Guid("2a023c7e-5733-4364-aed5-fc81fbd673dc"), 0, 40, "6f59a0b5-3bea-4b7e-9d41-3d145c89de33", "doctor1@mail.com", false, "Иван", "Мъж", "Петров", false, null, "DOCTOR1@MAIL.COM", "DOCTOR1@MAIL.COM", "AQAAAAEAACcQAAAAEOBksZMKtQuIxrp2bVHaTFA9lJYmDyNmAO5H/Sv0Hd6ZeB5a5Dov5kI6D7BeC3mSAw==", null, false, "cb31147e-0229-4c11-af86-2a1e1c0532e2", false, "doctor1@mail.com" },
                    { new Guid("346499bb-4636-4791-93c8-7ef0fd32a87d"), 0, 27, "be4f4571-fff1-4b4a-a655-3cfd124af468", "patient3@mail.com", false, "Петър", "Мъж", "Николов", false, null, "PATIENT3@MAIL.COM", "PATIENT3@MAIL.COM", "AQAAAAEAACcQAAAAEE3xG/laMFOFV4B+ab4MtiPdO3i3WAO0YFQQ+Vmi4mpomCV/MDnukvEC7WLBW5oeRA==", null, false, "57a9e70f-357b-42c9-9880-1f1da9dfb211", false, "patient3@mail.com" },
                    { new Guid("4eb44df6-f425-4243-bee9-e18d19968f06"), 0, 29, "d65c05d2-dda1-430e-b7a6-ac670d0891cf", "patient5@mail.com", false, "Ивайло", "Мъж", "Димитров", false, null, "PATIENT5@MAIL.COM", "PATIENT5@MAIL.COM", "AQAAAAEAACcQAAAAEBF3mM9z3Borf6wGQ+3/yzk+SvtYkIn4ojTatp7w0+pJmd0AmvKCLK3qbXiWOPFZ9w==", null, false, "5bbc0b4f-c8a6-4d63-9d6e-90880c83c0e2", false, "patient5@mail.com" },
                    { new Guid("74f6ca22-d948-4352-b4ba-722ed47b676a"), 0, 25, "2899cf88-0819-4685-9e54-c74cd35b29ed", "patient1@mail.com", false, "Георги", "Мъж", "Иванов", false, null, "PATIENT1@MAIL.COM", "PATIENT1@MAIL.COM", "AQAAAAEAACcQAAAAEIZcyBSyRCvjTSOf2LF/xfh/d8VIqYZp8UypGab47bhbQu6kXeZ9Ld/g3XZBGFOCCw==", null, false, "58b7de3d-25bc-486f-946b-74392c0c8d51", false, "patient1@mail.com" },
                    { new Guid("88e0d517-065a-49ab-bf2f-b9545e6791b1"), 0, 43, "f53ea4a5-e0be-4f30-8ba7-f13394e098ac", "doctor4@mail.com", false, "Яна", "Жена", "Танева", false, null, "DOCTOR4@MAIL.COM", "DOCTOR4@MAIL.COM", "AQAAAAEAACcQAAAAEBTo2+6kpPTCzk2hA3emz5f9iAiyYYVB9T+z/I1mLRwo/dv6wgrnKmMEXnEG1FRGIg==", null, false, "e2dfade3-dc45-47f6-b6a2-6dc5394706de", false, "doctor4@mail.com" },
                    { new Guid("ab61bdab-b0ff-42e2-bd61-e2e389b8b009"), 0, 28, "c585dc3e-a89f-4fc8-91c7-c9ef0e338555", "patient4@mail.com", false, "Мария", "Жена", "Тодорова", false, null, "PATIENT4@MAIL.COM", "PATIENT4@MAIL.COM", "AQAAAAEAACcQAAAAEJ7RBu9rATRCkO3aLaofoQ+zzS9eYaLJBkcZ+ZUD5+zivudPcCvnk+9UWP9ASX/uGQ==", null, false, "40b27e12-d967-4bdd-82f3-5bff11acb5d4", false, "patient4@mail.com" },
                    { new Guid("b2a9f3f8-70ef-4e4b-9214-61426bfe43df"), 0, 0, "f7e0b9c6-1ed2-44a2-8993-56ec05bf5005", "admin@mail.com", false, "Админ", "Друг", "Админов", false, null, "ADMIN@MAIL.COM", "ADMIN@MAIL.COM", "AQAAAAEAACcQAAAAEGux4xH8kNXEcAm9EehvFGZ3hUPrGcP63DzriDkLBmFMLA8D1rxUKV65nL57Lj/S4Q==", null, false, "657b10c6-e643-429e-9404-d119888490c4", false, "admin@mail.com" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Doctors",
                columns: new[] { "Id", "Description", "SpecializationId" },
                values: new object[,]
                {
                    { new Guid("0474b09e-b40c-4a07-821b-608382e23074"), "Д-р Станимир Колев е завършил Медицинския университет в Пловдив. Има над 10 години практика като дерматолог и е специализирал в областта на кожните автоимунни заболявания.", new Guid("34f31b29-3a0e-4203-8a32-01ac8690e314") },
                    { new Guid("14108175-e9b7-41e4-a85b-e69b16df9b60"), "Д-р Виктория Стоянова е дипломиран невролог от Медицинския университет в Варна. Работила е в МБАЛ \"Света Марина\" и има дългогодишен опит в лечението на неврологични заболявания.", new Guid("f4d444aa-ba0b-4ac3-a58f-5a34c317b29a") },
                    { new Guid("248cf7a1-4b05-461f-a6a2-155f897921de"), "Д-р Виктор Борисов е кардиолог, завършил Медицинския университет в Плевен. Има над 20 години стаж в областта на неинвазивната диагностика и лечението на сърдечни заболявания.", new Guid("d3495565-b898-4f91-b2b1-81907eee1249") },
                    { new Guid("2a023c7e-5733-4364-aed5-fc81fbd673dc"), "Д-р Иван Петров е завършил Медицинския университет в София. Има над 15 години опит като кардиолог в Александровска болница и е специализирал в Германия по инвазивна кардиология.", new Guid("d3495565-b898-4f91-b2b1-81907eee1249") },
                    { new Guid("88e0d517-065a-49ab-bf2f-b9545e6791b1"), "Д-р Яна Танева е ортопед с образование от Медицинския университет в София. Работила е в ортопедичното отделение на ВМА и има специален интерес към спортната медицина.", new Guid("0ad750ee-b4d1-49ee-b4d8-349f7f54efd8") }
                });
